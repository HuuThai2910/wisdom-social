...
public class PageJoinApprovedEventHandler implements RedisEventHandler {
    ...
    @Override
    public String getSupportedEventType() { return DomainEventType.PAGE_JOIN_APPROVED.toString(); }
