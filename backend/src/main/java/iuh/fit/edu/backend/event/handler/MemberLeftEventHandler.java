...
import iuh.fit.edu.backend.event.payload.MemberStatusChangedEvent;
...
public class MemberLeftEventHandler implements RedisEventHandler {
    ...
    public String getSupportedEventType() {
        return DomainEventType.MEMBER_LEFT.toString();
    }
