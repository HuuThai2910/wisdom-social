...
public class PageMemberLeftEventHandler implements RedisEventHandler {
    ...
    @Override
    public String getSupportedEventType() { return DomainEventType.PAGE_MEMBER_LEFT.toString(); }
