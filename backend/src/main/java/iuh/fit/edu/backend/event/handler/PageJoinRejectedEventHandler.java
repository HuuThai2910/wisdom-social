...
public class PageJoinRejectedEventHandler implements RedisEventHandler {
    ...
    @Override
    public String getSupportedEventType() { return DomainEventType.PAGE_JOIN_REJECTED.toString(); }
