...
public class PageJoinCancelledEventHandler implements RedisEventHandler {
    ...
    @Override
    public String getSupportedEventType() { return DomainEventType.PAGE_JOIN_CANCELLED.toString(); }
