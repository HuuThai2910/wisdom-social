...
public class PageMemberRoleChangedEventHandler implements RedisEventHandler {
    ...
    @Override
    public String getSupportedEventType() { return DomainEventType.PAGE_MEMBER_ROLE_CHANGED.toString(); }
