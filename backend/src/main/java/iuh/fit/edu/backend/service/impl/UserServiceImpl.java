...
public class UserServiceImpl implements UserService {
    ...
    * */
    ...
    public UserResponseLogin loginUser(UserRequestLogin login) {
        ...
        // Nếu có username (không có password) - dùng cho development
        if (login.getUsername() != null && !login.getUsername().isEmpty() && 
            ...
            if (user != null) {
                return UserResponseLogin.builder()
                        ...
                        .refreskToken("dev-refresh-token")
        ...
        // Login bình thường với phone và password qua Cognito
    ...
    @Override
    public UserResponseLogin testLoginByUsername(String username) {
