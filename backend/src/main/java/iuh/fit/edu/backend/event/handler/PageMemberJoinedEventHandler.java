...
public class PageMemberJoinedEventHandler implements RedisEventHandler {
    ...
    @Override
    public String getSupportedEventType() { return DomainEventType.PAGE_MEMBER_JOINED.toString(); }
