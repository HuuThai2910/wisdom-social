...
public class PageMemberBlockedEventHandler implements RedisEventHandler {
    ...
    @Override
    public String getSupportedEventType() { return DomainEventType.PAGE_MEMBER_BLOCKED.toString(); }
