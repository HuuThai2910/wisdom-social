                ...
                >
                    ...
                    <View style={ds.tabBar}>
                        ...
                        >
                            ...
                            />
                            <Text style={[ds.tabText, selectedTab === "posts" && ds.tabTextActive]}>
                                Bài viết
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                        ...
                        >
                            ...
                            />
                            <Text style={[ds.tabText, selectedTab === "saved" && ds.tabTextActive]}>
                                Đã lưu
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                        ...
                        >
                            ...
                            />
                            <Text style={[ds.tabText, selectedTab === "blocked" && ds.tabTextActive]}>
                                Đã chặn
                            </Text>
                        </TouchableOpacity>
                    </View>
                                ...
                                {blockedUsers.map((bu) => (
                                    <View key={bu.id} style={ds.blockedRow}>
                                        ...
                                        <View style={{ flex: 1, marginLeft: 12 }}>
                                            ...
                                            {bu.username && <Text style={ds.blockedUsername}>@{bu.username}</Text>}
                                        </View>
                                        <TouchableOpacity
                                            style={ds.unblockBtn}
                        ...
                        <View style={[ds.sheet, { paddingBottom: insets.bottom + 16 }]}>
                            ...
                            <View style={ds.sheetHeader}>
                                ...
                                <TouchableOpacity onPress={handleSaveProfile} disabled={isSaving} hitSlop={12}>
                                    <Text
                                        style={[ds.sheetSave, isSaving && { color: colors.textMuted }]}
                                    >
