  ...
  return (
    <SafeAreaView style={styles.container}>
      <AppHeader
        ...
        rightActions={[
          { icon: "settings-outline", onPress: () => router.push("/(stack)/profile/settings") },
          { icon: "menu-outline", onPress: () => router.push("/(stack)/profile/menu") },
        ]}
      />
      ...
      <ScrollView>
        ...
        <View style={styles.quickActions}>
          <Pressable style={styles.quickBtn} onPress={() => router.push("/(stack)/profile/my-posts")}>
            <Text style={styles.quickBtnText}>My Posts</Text>
          </Pressable>
          <Pressable
            style={styles.quickBtn}
            onPress={() => router.push("/(stack)/profile/saved-posts")}
          >
            <Text style={styles.quickBtnText}>Saved</Text>
          </Pressable>
          <Pressable
            style={styles.quickBtn}
            onPress={() => router.push("/(stack)/profile/following")}
          >
        ...
        {gridData.length === 0 ? (
          <EmptyState title="Chưa có nội dung" description="Hãy đăng bài hoặc lưu bài viết." />
        ) : (
