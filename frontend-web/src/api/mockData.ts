import type { User, Post, Story, Chat, Message, Notification, Page } from '../types';
...
export const mockPages: Page[] = [
    {
        ...
        category: 'Brand',
        description: 'Inspiring people to care about the planet since 1888. 🌍 Explore our world through stunning photography and storytelling.',
        website: 'https://nationalgeographic.com',
        location: 'Washington, D.C.',
        followersCount: 285000000,
        postsCount: 14200,
        isFollowed: true,
        isVerified: true,
    ...
    },
    {
        ...
        category: 'Technology',
        description: 'Breaking technology news, analysis and opinions from TechCrunch — the leading source of tech journalism.',
    ...
    },
    {
        ...
        category: 'Food',
        description: 'The world\'s largest food network. 🍕🍣🍰 Recipes that will make you drool.',
    ...
    },
    {
        ...
        description: 'Fashion, beauty, culture. The definitive fashion magazine.',
        website: 'https://vogue.com',
        location: 'New York, NY',
        followersCount: 33000000,
        postsCount: 12300,
        isFollowed: false,
        isVerified: true,
    ...
    },
    {
        ...
        category: 'Sports',
        description: 'Your daily dose of fitness motivation 💪 | Workouts, nutrition tips & healthy lifestyle.',
    ...
    },
    {
        ...
        username: 'travelandadventure',
        avatar: 'https://i.pravatar.cc/150?img=17',
        coverImage: 'https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200',
        category: 'Travel',
        description: 'Discover breathtaking destinations around the world ✈️🌏 | Travel tips, guides & inspiration.',
        website: 'https://travelandadventure.com',
        location: 'London, UK',
        followersCount: 8700000,
        postsCount: 6700,
        isFollowed: false,
        isVerified: false,
    ...
    },
    {
        id: 'p8',
        name: 'Art & Design Hub',
        username: 'artdesignhub',
        avatar: 'https://i.pravatar.cc/150?img=18',
        coverImage: 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=1200',
        category: 'Artist',
        description: 'Celebrating creativity, art & design from around the world 🎨✨',
        website: 'https://artdesignhub.com',
...
// Mock Page Posts
export const mockPagePosts: Post[] = [
    {
        id: 'pp1',
        user: mockUsers[0],
        images: ['https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=800'],
        caption: 'The world is full of wonders. 🌍 #NatGeo #Nature #Photography',
        likes: 45230,
        comments: [
            {
                id: 'ppc1',
    ...
    },
    {
        ...
        caption: 'Adventure awaits at every turn. 🏔️ #Travel #Explore',
        likes: 32100,
        comments: [],
        createdAt: '1d ago',
        isLiked: true,
    ...
    },
    {
        ...
        caption: 'Lions – the pride of the savanna. 🦁 #Wildlife #Africa',
        likes: 67800,
        comments: [],
        createdAt: '2d ago',
        isLiked: false,
    ...
    },
    {
        id: 'pp4',
        user: mockUsers[0],
        images: ['https://images.unsplash.com/photo-1518020382113-a7e8fc38eac9?w=800'],
        caption: 'Oceans cover more than 70% of our planet. Protect them. 🌊 #Ocean #Conservation',
        likes: 89200,
        comments: [
            {
                id: 'ppc2',
    ...
    },
    {
        ...
        caption: 'Northern Lights – nature\'s most spectacular light show. 🌌 #AuroraBorealis',
        likes: 124500,
        comments: [],
        createdAt: '4d ago',
        isLiked: true,
    ...
    },
    {
        ...
        caption: 'Mountains remind us how small we are, and how vast the world is. 🏔️',
        likes: 58700,
        comments: [],
        createdAt: '5d ago',
        isLiked: false,
